...
AppSettings _$AppSettingsFromJson(Map<String, dynamic> json) => AppSettings(
  ...
  kleSatz: (json['kleSatz'] as num?)?.toDouble() ?? 0.722,
  erbringungsfiktion: json['erbringungsfiktion'] as bool? ?? false,
...
Map<String, dynamic> _$AppSettingsToJson(AppSettings instance) =>
    <String, dynamic>{
      ...
      'kleSatz': instance.kleSatz,
      'erbringungsfiktion': instance.erbringungsfiktion,
...
const _$BundeslandEnumMap = {
  Bundesland.badenWuerttemberg: 'badenWuerttemberg',
  ...
  Bundesland.mecklenburgVorpommern: 'mecklenburgVorpommern',
  Bundesland.niedersachsen: 'niedersachsen',
  Bundesland.nordrheinWestfalen: 'nordrheinWestfalen',
  Bundesland.rheinlandPfalz: 'rheinlandPfalz',
  Bundesland.saarland: 'saarland',
  Bundesland.sachsen: 'sachsen',
  Bundesland.sachsenAnhalt: 'sachsenAnhalt',
  Bundesland.schleswigHolstein: 'schleswigHolstein',
