          ...
          Column(
            children: [
              RadioListTile<ExportZiel>(
                ...
                title: const Text('Lokal speichern'),
                subtitle: const Text('Speicherort wählen',
                    style: TextStyle(fontSize: 12)),
                secondary: const Icon(Icons.save_alt, size: 20),
              ),
              RadioListTile<ExportZiel>(
                dense: true,
                contentPadding: EdgeInsets.zero,
                ...
                groupValue: _ziel,
                onChanged: (v) => setState(() => _ziel = v!),
                title: const Text('Teilen / Per E-Mail'),
                subtitle: const Text('Öffnet Teilen-Dialog des Systems',
                    style: TextStyle(fontSize: 12)),
                secondary: const Icon(Icons.share, size: 20),
              ),
            ],
          ),
        ],
