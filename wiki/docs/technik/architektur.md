...
| Verschluesselung | AES-256-GCM (cryptography, crypto) |
| Cloud-Sync | WebDAV (STRATO HiDrive Business) |
...
| Authentifizierung | local_auth (Biometrie), eigene TOTP-Implementierung |
...
│   └── ...                   # Weitere Modelle
├── providers/
│   └── app_provider.dart     # Zentraler App-State (ChangeNotifier)
├── services/                 # Business-Logik
│   ├── secure_storage_service.dart   # Datenpersistenz
│   ├── crypto_storage.dart           # Verschluesselung (MEK/DEK)
...
│   ├── recovery_service.dart         # Passwort-Recovery
│   ├── document_lock_service.dart    # Dokument-Locking
│   ├── pdf_generator_service.dart    # PDF-Export
│   ├── export_service.dart           # CSV/JSON-Export
│   ├── gdpr_service.dart             # DSGVO-Funktionen
│   ├── message_service.dart          # Nachrichtensystem
